...
?>
    <div id="container">
        <div class="back">
            <a href="products.php">&lt Products</a><a href="men.php">&lt Men</a>
        ...
        <section class="board">
            <div class="os-container">
                <?php
                    $sql = "SELECT * FROM products WHERE productsCat = 'Men' AND productsType = 'T-Shirts' ORDER BY id DESC;";
                ...
                <?php
                    if (isset($_POST['filter'])) {
                        ...
                        $sql = "SELECT * FROM products WHERE productsCat = 'Men' AND productsType = 'T-Shirts' AND productsCond >= '$cond' AND productsSize = '$size' AND productsPrice <= '$priceto' ORDER BY id DESC;";
                        $result = mysqli_query($conn, $sql);
                        $resultCheck = mysqli_num_rows($result);
