...
?>
    <div id="container">
        <div class="back">
            <a href="products.php">&lt Products</a><a href="kids.php">&lt Kids</a>
        ...
        <section class="board">
            <div class="os-container">
                <?php
                    $sql = "SELECT * FROM products WHERE productsCat = 'Kids' AND productsType = 'Sweatshirts' ORDER BY id DESC;";
